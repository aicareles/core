...
public class DefaultItemTouchHelpCallback extends ItemTouchHelper.Callback {
    ...
    private static final String TAG = "DefaultItemTouchHelpCal";
    /**
     * Item操作的回调
     */
    ...
    public int getMovementFlags(RecyclerView recyclerView, RecyclerView.ViewHolder viewHolder) {
        if (viewHolder.getAdapterPosition() == fixedPosition || !isCanDrag){
    ...
    public boolean onMove(RecyclerView recyclerView, RecyclerView.ViewHolder srcViewHolder, RecyclerView.ViewHolder targetViewHolder) {
        if (srcViewHolder.getAdapterPosition()==fixedPosition || targetViewHolder.getAdapterPosition()==fixedPosition){
            return false;
        }
