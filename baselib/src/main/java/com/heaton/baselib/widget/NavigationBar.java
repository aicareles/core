...
public class NavigationBar extends LinearLayout implements View.OnClickListener {
    ...
    public NavigationBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        ColorStateList tabTextColor = typedArray.getColorStateList(R.styleable.NavigationBar_navigateTabTextColor);
        ColorStateList selectedTabTextColor = typedArray.getColorStateList(R.styleable.NavigationBar_navigateTabSelectedTextColor);

        mTabTextSize = typedArray.getDimensionPixelSize(R.styleable.NavigationBar_navigateTabTextSize, 0);
        mMainContentLayoutId = typedArray.getResourceId(R.styleable.NavigationBar_containerId, 0);
        mTabItemLayout = typedArray.getResourceId(R.styleable.NavigationBar_tabItemLayout, R.layout.default_nav_tabview);

        mNormalTextColor = (tabTextColor != null ? tabTextColor : context.getResources().getColorStateList(android.R.color.background_dark));
    ...
    public void addTab(Class frameLayoutClass, TabParam tabParam) {
        ...
        View view = LayoutInflater.from(getContext()).inflate(mTabItemLayout, null);
